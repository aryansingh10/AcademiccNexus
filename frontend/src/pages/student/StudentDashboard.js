...
import SocialScience from "./SocialLecture.js";
      ...
      <Box sx={{ display: "flex" }}>
        ...
        <Box component="main" sx={styles.boxStyled}>
          ...
          <Routes>
            ...
            <Route
              path="/view-lectures-Maths"
              element={<MachineLearningLectures />}
            />
            <Route
              path="/view-lectures-English"
              element={<ComputerNetworksLectures />}
            />
            <Route
              path="/view-lectures-SocialScience"
